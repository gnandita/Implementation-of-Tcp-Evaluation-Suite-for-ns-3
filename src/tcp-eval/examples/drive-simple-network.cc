...
#include "ns3/simple-network-topology.h"

using namespace ns3;

NS_LOG_COMPONENT_DEFINE ("TcpEvalSimpleNetworkExample");
...
// Set default values for topology
  ...
  std::string fileName = "TcpEvalSimpleNetwork";
  ...
  cmd.AddValue ("coreLinkBandwidth", "Bandwidth of core router link in Mbps", coreLinkBandwidth);
  ...
  Config::SetDefault ("ns3::ConfigureTopology::CoreLinkBandwidth", DoubleValue (coreLinkBandwidth));
